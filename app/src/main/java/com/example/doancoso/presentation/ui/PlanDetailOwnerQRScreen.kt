...
@Composable
fun PlanDetailOwneQRScreen(
    navController: NavHostController,
    authViewModel: AuthViewModel,
    planId: String,
    ownerUid: String,  // Thêm tham số này
    ...
    val isFromDeepLink = planId.isNotEmpty()

    LaunchedEffect(planId, ownerUid) {
        if (authState is AuthState.Idle || user == null) {
            ...
            planViewModel.fetchPlanByIdFromFirebase(ownerUid, planId)
        }
    }
